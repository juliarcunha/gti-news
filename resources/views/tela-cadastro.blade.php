    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <form action="{{route('SalvaUsuario')}}" method="post">
                ...
                <button type="submit" class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-black bg-pink-300 rounded-lg focus:ring-4 focus:ring-pink-300 focus:ring-pink-300 hover:bg-pink-300">
                    Cadastrar
                </button>
            </form>
        </div>
